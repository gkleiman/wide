...
;bespin.tiki.register("::c_cpp_syntax", {
    name: "c_cpp_syntax",
    dependencies: { "standard_syntax": "0.0.0" }
});
bespin.tiki.module("c_cpp_syntax:index",function(require,exports,module) {
/*
...
"define metadata";
({
    "description": "C/C++ syntax highlighter",
    "dependencies": { "standard_syntax": "0.0.0" },
    "environments": { "worker": true },
    "provides": [
        {
...
var states = {
    start: [
        {
            regex:  /^(?:#include|#pragma|#line|#define|#undef|#ifdef|#else|#elif|#endif|#ifndef|and|double|not_eq|throw|and_eq|dynamic_cast|operator|true|asm|else|or|try|auto|enum|or_eq|typedef|bitand|explicit|private|typeid|bitor|extern|protected|typename|bool|false|public|union|break|float|register|unsigned|case|fro|reinterpret-cast|using|catch|friend|return|virtual|char|goto|short|void|class|if|signed|volatile|compl|inline|sizeof|wchar_t|const|int|static|while|const-cast|long|static_cast|xor|continue|mutable|struct|xor_eq|default|namespace|switch|delete|new|template|do|not|this)(?![a-zA-Z0-9_])/,
            tag:    'keyword'
        },
        {
      	    regex:  /^[A-Za-z_][A-Za-z0-9_]*/,
...
exports.C_CPPSyntax = new StandardSyntax(states);
